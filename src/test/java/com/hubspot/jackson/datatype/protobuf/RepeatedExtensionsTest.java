...
public class RepeatedExtensionsTest {
  ...
  public void testSingleMessageCamelCase() {
    RepeatedFields message = ProtobufCreator.create(
      RepeatedFields.class,
      EXTENSION_REGISTRY
    );
  ...
  public void testMultipleMessagesCamelCase() {
    List<RepeatedFields> messages = ProtobufCreator.create(
      RepeatedFields.class,
      EXTENSION_REGISTRY,
      10
    );
  ...
  public void testSingleMessageMixedUnderscoreNamingStrategies() throws IOException {
    ...
    RepeatedFields parsed = oldUnderscore(EXTENSION_REGISTRY)
      .treeToValue(json, RepeatedFields.class);
  ...
  public void testMultipleMessagesMixedUnderscoreNamingStrategies() {
    ...
    List<RepeatedFields> parsed = parseList(
      oldUnderscore(EXTENSION_REGISTRY),
      RepeatedFields.class,
      json
    );
  ...
  public void testSingleBuilderMixedUnderscoreNamingStrategies() throws IOException {
    ...
    RepeatedFields.Builder parsed = oldUnderscore(EXTENSION_REGISTRY)
    ...
    parsed =
      newUnderscore(EXTENSION_REGISTRY).treeToValue(json, RepeatedFields.Builder.class);
  ...
  public void testMultipleBuildersMixedUnderscoreNamingStrategies() {
    ...
    parsed =
      parseList(newUnderscore(EXTENSION_REGISTRY), RepeatedFields.Builder.class, json);
